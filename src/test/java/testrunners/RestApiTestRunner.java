...
@CucumberOptions(
		features = "src/test/resources/parallel/RestApiCalls.feature",
		glue= {"stepDefinitions"},
		plugin = { "pretty", "json:target/cucumber-reports/RestApiCalls.json",
				"junit:target/cucumber-reports/RestApiCalls.xml",
